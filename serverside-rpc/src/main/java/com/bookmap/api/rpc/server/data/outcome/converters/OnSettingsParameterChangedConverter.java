...
@Singleton
public class OnSettingsParameterChangedConverter
    implements EventConverter<OnSettingsParameterChangedEvent, String> {
  ...
  public String convert(OnSettingsParameterChangedEvent entity) {
    ...
    System.out.println("OnSettingsParameterChangedConverter: " +
                       builder.toString());
